...
const Orderhistory = () => {
  ...
  return (
    <HomeLayout>
      <section className="p-[100px] font-montserrat ">
        <div className="border border-gray-300 rounded-lg p-[50px] ">
          <div className="border px-9 py-4 flex justify-between bg-[#EBF6F6] ">
            <div className="flex">
              <div>
          ...
          <div className="flex py-4 md:space-x-3">
            ...
            <div className="flex text-[17px] justify-between w-full font-[500] ">
              ...
              <p className="text-green-400 text-[14px] font-semibold ">
                Buy Again
              </p>
            </div>
          </div>
        ...
        <div className="border mt-20 border-gray-300 rounded-lg p-[50px] ">
          <div className="border px-9 py-4 flex justify-between bg-[#EBF6F6] ">
            <div className="flex">
              <div>
                <p className="text-black  font-bold text-[17px] ">
