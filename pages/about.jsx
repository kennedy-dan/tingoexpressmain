    ...
    <HomeLayout>
      <section>
        ...
        <div className="md:flex justify-between font-montserrat md:space-x-10 py-10 px-6 lg:px-[20px] lg:py-[20px] xl:px-[100px] xl:py-[100px]  ">
          ...
          <div>
            <p className="md:text-[30px] text-[17px] mt-10 font-semibold ">Our Vission</p>
            ...
            <p className="md:text-[30px] text-[17px] mt-6 font-semibold ">Our Mission</p>
            ...
            <p className="md:text-[30px] text-[17px] mt-6 font-semibold ">Core Values</p>
            <p className="font-[400] md:text-[14px] text-[13px] pt-3 pb-5 ">
              Lorem ipsum dolor sit amet consectetur. Sodales velit elementum
              gravida nibh ultrices urna egestas lectus tempus. Eu eu dui tellus
              mattis feugiat et elementum convallis sit. Velit porttitor nam
